...
let siteBtn = document.getElementById("website");
...
emailBtn.addEventListener("click", () => {
  let user = users[index];
  text.innerHTML = "My Email is";
  personName.innerHTML = user.email;
});
usernameBtn.addEventListener("click", () => {
  let user = users[index];
  text.innerHTML = "My user Name is";
  personName.innerHTML = user.username;
});
phoneBtn.addEventListener("click", () => {
  let user = users[index];
  text.innerHTML = "My Phone is";
  personName.innerHTML = user.phone;
});
siteBtn.addEventListener("click", () => {
  let user = users[index];
  text.innerHTML = "my site address is";
  personName.innerHTML = user.website;
});
addressBtn.addEventListener("click", () => {
  let user = users[index];
  text.innerHTML = "my address is";
  personName.innerHTML = user.address.city;
});
